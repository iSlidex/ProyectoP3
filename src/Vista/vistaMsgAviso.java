 ...
 * @author leito
 */
public class vistaMsgAviso extends javax.swing.JDialog {
int i,j;
    /**
     * Creates new form vistaMsgAviso
     */
    public vistaMsgAviso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public vistaMsgAviso(java.awt.Frame parent, boolean modal,String mensaje) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/icons8_Alert_25px.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaMsgAviso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaMsgAviso dialog = new vistaMsgAviso(new javax.swing.JFrame(), true);

 ...
 * @author leito
 */
public class admVistaProv extends javax.swing.JFrame {
...
boolean activados;
    /**
     * Creates new form admVistaProv
     */
    public admVistaProv() {
        initComponents();
        verProd5.requestFocus(); 
    }
    public admVistaProv(Usuario currentUser){
        initComponents();
    ...
    private void initComponents() {
        ...
        verProd3.setFocusTraversalPolicyProvider(true);
        ...
        bttn17.setText("Proveedores registrados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admVistaProv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admVistaProv().setVisible(true);
            }
        });
    }

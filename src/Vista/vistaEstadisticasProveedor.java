...
int i,j;
    ...
    public vistaEstadisticasProveedor() {
     ...
     public vistaEstadisticasProveedor(Usuario currentUser) {
        initComponents();
        control = new controlEstadisticas(tablaStats, this);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(761, 16, -1, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/outline_local_grocery_store_white_18dp_1.png"))); // NOI18N
        ...
        verProd3.setBackground(new java.awt.Color(0, 153, 204));
        ...
        background.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 10, -1, -1));
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/icons8_PDF_20px.png"))); // NOI18N
        jLabel17.setText("Reporte Proveedor");
        ...
        jLabel17.setBounds(10, 0, 170, 40);

        background.add(verProd4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 630, 190, 40));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/icons8_PDF_20px.png"))); // NOI18N
        jLabel18.setText("Guardar Reporte");
        ...
        jLabel18.setBounds(10, 0, 160, 40);

        background.add(verProd5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 630, 170, 40));
    ...
    private void verProd3FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_verProd3FocusLost
        verProd3.setBackground(new java.awt.Color(0,153,204));
        bttn15.setBackground(new java.awt.Color(0,153,204));
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        try {
            MessageFormat headerFormat = new MessageFormat("Estadísticas de proveedor\n\n"); //Encabezado
            MessageFormat footerFormat = new MessageFormat("CONSTRUCTORES 3000 C.A."); //Pie de página
            tablaStats.print(JTable.PrintMode.FIT_WIDTH, headerFormat, footerFormat);
        } catch (PrinterException e) {
            Logger.getLogger(vistaEstadisticasProveedor.class.getName()).log(Level.SEVERE, null, e);
        }

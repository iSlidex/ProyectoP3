 ...
 * @author leito
 */
public class vistaMsg2 extends javax.swing.JDialog {
    int i,j;
    /**
     * Creates new form vistaMsg2
     */
    public vistaMsg2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public vistaMsg2(java.awt.Frame parent, boolean modal,String mensaje) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaMsg2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaMsg2 dialog = new vistaMsg2(new javax.swing.JFrame(), true);
